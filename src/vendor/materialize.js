...
;(function ($, anim) {
  $(document).on('click', '.card', function (e) {
    if ($(this).children('.card-reveal').length) {
      ...
      let ActiveReveal = document.querySelectorAll('.cardRevealActive');
      ...
      if ($(e.target).is($('.card-reveal .reveal-activator')) || $(e.target).is($('.card-reveal .reveal-activator'))) { 
        // Make Reveal animate down and display none
        /*
        removeClass($cardReveal, 'cardRevealActive');
      */
        ...
        */
        ...
        /*
        removeClass(ActiveReveal, 'cardRevealActive');
        addClass($cardReveal, 'cardRevealActive');
        */
        /*
        anim({
          targets: $cardReveal[0],
