                    ...
                    if (d.length >= set.minimumLength)
                    {
                         if (standard)
                         {
                              ...
                              for (var i = 0; i < tipuesearch.pages.length; i++)
                              {
                                   ...
                                   for (var f = 0; f < d_w.length; f++)
                                   {
                                        if (set.wholeWords)
                                        {
                                             var pat = new RegExp('\\b' + d_w[f] + '\\b', 'giu');
                                          //   var pat = new RegExp('[\u0400-\u04FF]', 'gi');
                                        }
                                        else
                                        {
                                            // var pat = new RegExp(d_w[f], 'gi');
                                             var pat = new RegExp(d_w[f], 'giu');
                                        }
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {
                                        out += '<div class="container tipue_search_result">';
                                                                           
                                        out += '<div class="tipue_search_content_title"><a href="' + found[i].url + '"' + tipue_search_w + '>'  + '</a></div>'; //+  found[i].title
